...
def generate_deployment(app_name: str, image: str, port: int = 8000,
                         replicas: int = 2, cpu_request: str = "100m",
...
def generate_all(app_name: str, image: str, host: str,
                  output_dir: str = "./k8s", port: int = 8000,
                  replicas: int = 2, tls: bool = False,
                  cert_secret: str = None, service_type: str = "ClusterIP",
