"""
epl.stdlib_modules.cloud — Cloud domain public API.

Facade over the cloud functions in cloud_backend.py.
Provides function registry and documentation for the LSP,
type checker, and other introspection tools.
"""
...
DOCS: dict[str, str] = {
    # Configuration
    'cloud_configure':        'Configure AWS credentials and region (region, access_key, secret_key).',
